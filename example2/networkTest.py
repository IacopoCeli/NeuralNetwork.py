...
testSetInputs = testSet[["attr1", "attr2", "attr3", "attr4", "attr5", "attr6", "attr7", "attr8", "attr9"]]
testSetTargets = testSet[["result"]].rename(columns={"result" : "targets"})

trainingSet = pd.read_csv("results/trainingSet.csv")
trainingSetInputs = trainingSet[["attr1", "attr2", "attr3", "attr4", "attr5", "attr6", "attr7", "attr8", "attr9"]]
...
for neuralNet in netFiles:
    ...
    # Calcolo l'errore quadratico sulle singole tuple tra il risultato ottenuto e il risultato atyteso
    squaredError = []
